...
1 in 5 epilepsy patients experience seizures caused by structural abnormality in the brain. For these patients, resection surgery to remove the epileptogenic zone is one of the best chances of cure, and complete resection of the epileptogenic zone is important for achieving seizure freedom. Quantitative assessment of resection completeness requires:
...
To address this challenge, we developed MELD-PosTOp, a deep learning tool that automatically segments resection cavities directly from postoperative 3D T1-weighted MRI scans, without requiring additional preprocessing or additional modalities.
...
### Publication ###
For more details, the manuscript in Epilepsia is available here: [MELD-PostOp]( https://onlinelibrary.wiley.com/doi/epdf/10.1002/epi.70450)
